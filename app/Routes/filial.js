 ...
 */
Route.get('/api/filiais', 'Api/FilialController.index')
 ...
 */
Route.get('/api/filiais/:id', 'Api/FilialController.show')
 ...
 */
Route.post('/api/filiais', 'Api/FilialController.store')
 ...
 *         description: Filial não encontrada
 */
Route.put('/api/filiais/:id', 'Api/FilialController.update')
 ...
 *         description: Filial não encontrada
 */
Route.delete('/api/filiais/:id', 'Api/FilialController.destroy') 